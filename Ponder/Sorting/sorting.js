...
const people = [{name: "Carl"}, {name: "Bob"}, {name: "Alan"}]
people.sort(sortPeopleByNames);

// console.log(people);

function sortPeopleByNames(a,b){
...
searchButton.addEventListener("click", e => {
    ...
    let sortedHikes = filteredHikes.sort(sortHikesByDifficulty, hikes);
