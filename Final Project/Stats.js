const tracks = [
    ...
    { tag: "circuit", name: "Bahrain International Circuit", country: "Bahrain", length: "5.412 km", laps: 57, image: "track_images/2026tracksakhirdetailed.avif" },
    ...
    { tag: "circuit", name: "Marina Bay Street Circuit", country: "Singapore", length: "4.940 km", laps: 62, image: "track_images/2026tracksingaporedetailed.avif" },
    ...
    { tag: "circuit", name: "Red Bull Ring", country: "Austria", length: "4.318 km", laps: 71, image: "track_images/2026trackspielbergdetailed.avif" },
    
    { tag: "circuit", name: "Suzuka Circuit", country: "Japan", length: "5.807 km", laps: 53, image: "track_images/2026tracksuzukadetailed.avif" },

    { tag: "circuit", name: "Yas Marina Circuit", country: "United Arab Emirates", length: "5.281 km", laps: 58, image: "track_images/2026trackyasmarinacircuitdetailed.avif" },
...
const drivers = [
    ...
    { tag: "driver", name: "Charles Leclerc", age: 28, country: "Monaco", team: "Ferrari", yearsDriving: 8, image: "driver_images/2026ferrarichalec01right.avif" },    { tag: "driver", name: "Lewis Hamilton", age: 41, country: "United Kingdom", team: "Ferrari", yearsDriving: 20, image: "driver_images/2026ferrarilewham01right.avif" },
