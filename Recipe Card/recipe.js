...
// tags, description, image, name, rating
...
function search() {
    ...
    let filteredRecipes = recipes.filter(function(recipe){
        return ( 
            ...
            recipe.tags.find(tag => tag.toLowerCase().includes(recipeSearch.toLowerCase()))
        );
    })
...
let recipeCard = document.querySelector('#cardContainer');
